...
from utils.dataset import MangoDataset,COCODataset,YOLODataset, collateFunction
...
def main(args):
    ...
    dataset = YOLODataset( args.dataDir, args.targetHeight, args.targetWidth, 2)
    
    # dataset = COCODataset(args.annFile, args.dataDir, args.targetHeight, args.targetWidth, args.numClass)
...
if __name__ == '__main__':
    ...
    # MARK: - dataset
    parser.add_argument('--dataDir', default='/Users/Gaurang/Desktop/temp/Modified-DETR/Mango_Dataset/train/images', type=str)
